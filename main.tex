...
\storeglosentry{uri}{name=URI,description={é um Identificador Uniforme de Recursos (Uniform Resource Identifier), é uma cadeia de carateres compacta usada para identificar ou denominar um recurso na Internet ou rede local. Mais detalhes em \url{http://www.faqs.org/rfcs/rfc2396.html}}}
\storeglosentry{url}{name=URL,description={é um Localizador Uniforme de Recursos (Uniform Resource Locator), é um endereço de um recurso disponível em uma rede, seja a rede internet ou intranet. É derivado do URI. Mais detalhes em \url{http://www.faqs.org/rfcs/rfc1738.html}}}
% -- glossary
...
\include{chapters/servicos-internet}
