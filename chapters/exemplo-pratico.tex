...
Por fim, temos o menu. Clique com o botão direito do \textit{mouse} em seu projeto e \menuaction{New
$\rightarrow$ Other...} ou \menuaction{Ctrl + N}. Procure por \texttt{Android XML File}. Em \texttt{Resource
...
\inlinecode{irParaSalvar} da classe \texttt{MainActivity} da seguinte maneira:
...
capaz de ler e escrever no banco de dados graças aos métodos \inlinecode{getReadableDatabase()} e
\inlinecode{getWritableDatabase()}, respectivamente.
